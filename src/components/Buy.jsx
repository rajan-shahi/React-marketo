      ...
      <div className=" flex    h-full md:h-[60vh] bg-[#1D1A39]">
        <div className=" md:flex justify-center items-center gap-6 md:px-20 px-4 md:pb-0 pb-20">
          ...
          <div className=" flex flex-col  gap-4">
            ...
            <div className="    grid md:grid-cols-2 grid-cols-1 md:gap-1 gap-6">
              <button className="   bg-red-700  w-56 py-3  text-white  hover:bg-orange-400  font-bold">
                Buy Now
              </button>
              <button className="  bg-black  w-60 py-3  text-white  font-bold border-2 border-white hover:border-orange-400">
                VIEW COLLECTIONS
              </button>
            </div>
          </div>
